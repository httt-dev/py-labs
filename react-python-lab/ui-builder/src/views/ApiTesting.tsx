...
export function ApiTesting() {
  ...
  const postgreBaseUrl = ctx?.settings?.postgreBaseUrl?.replace(/\/+$/, "");
    ...
    try {
      ...
      if (postgreResult) {
        ...
        testRecord.postgreResponse = {
          ...
          body: postgreResult.content
            ? beautifyJsonp(postgreResult.content)
            : "",
        };
      }
  ...
  return (
    <div className="relative flex flex-col w-full h-full bg-white overflow-hidden px-4 pt-4 gap-2">
      {/* API Path Section */}
          ...
          <div className="flex flex-col gap-2 h-full">
            ...
            {dualInputMode ? (
              <div className="grid grid-cols-2 gap-4 h-full">
                <div className="flex flex-col gap-2 h-full">
                  <p className="text-orange-500 text-sm font-medium">Oracle</p>
                  <Editor
                    language="json"
                    value={oracleBody}
                    onChange={(value) =>
            ...
            <div className="grid grid-cols-2 gap-4 flex-1 h-full">
              <div className="flex flex-col gap-2 h-full">
                ...
                <Editor
                  ...
                  // className={oracleStatus?.statusCode == -1 ? "hidden" : ""}
                  height="90%"
                />
              </div>
              <div className="flex flex-col gap-2 w-full h-full">
                ...
                <Editor
                  ...
                  // className={postgreStatus?.statusCode == -1 ? "hidden" : ""}
                  height="90%"
                />
              </div>
            </div>
